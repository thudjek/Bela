        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InGame = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dropouts = table.Column<int>(nullable: false),
                    UserStatus = table.Column<int>(nullable: false),
                    CameOnline = table.Column<DateTime>(nullable: true),
                    LastSeenOnline = table.Column<DateTime>(nullable: true),
                    RoomId = table.Column<int>(nullable: true),
                    IsReady = table.Column<bool>(nullable: false),
                    RoomOrderNumber = table.Column<int>(nullable: true),
                    MainHubConnectionId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
